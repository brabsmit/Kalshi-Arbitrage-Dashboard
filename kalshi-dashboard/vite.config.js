...
export default defineConfig({
  ...
  server: {
    ...
    headers: {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; connect-src 'self' https://api.the-odds-api.com https://api.elections.kalshi.com; img-src 'self' data:; font-src 'self' data:; object-src 'none'; base-uri 'self';",
    },
    proxy: {
      '/api/kalshi': {
