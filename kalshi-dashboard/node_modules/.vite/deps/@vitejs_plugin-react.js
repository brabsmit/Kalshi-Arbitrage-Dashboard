import {
  node_exports
} from "./chunk-QHDCDDHO.js";
import {
  createFilter,
  require_node_fs
} from "./chunk-ZNLBBDZP.js";
import "./chunk-YDLPXHFR.js";
import "./chunk-6UWTQYMU.js";
import "./chunk-OMMFQANJ.js";
import "./chunk-T7PESDY5.js";
import "./chunk-UU4NSABG.js";
import "./chunk-SOVYGP75.js";
...
function makeIdFiltersToMatchWithQuery(input) {
  if (!Array.isArray(input))
    return makeIdFilterToMatchWithQuery(input);
...
var silenceUseClientWarning = (userConfig) => ({ rollupOptions: { onwarn(warning, defaultHandler) {
  ...
  if (warning.code === "SOURCEMAP_ERROR" && warning.message.includes("resolve original location") && warning.pos === 0)
    return;
  if ((_userConfig$build = userConfig.build) === null || _userConfig$build === void 0 || (_userConfig$build = _userConfig$build.rollupOptions) === null || _userConfig$build === void 0 ? void 0 : _userConfig$build.onwarn)
...
async function loadBabel() {
  if (!babel)
    babel = await import("./lib-7PNJDVNZ.js");
  return babel;
}
...
function viteReact(opts = {}) {
  ...
  const viteBabel = {
    ...
    configResolved(config) {
      ...
      if ("rolldownVersion" in node_exports && !opts.babel && !hooks.length && !opts.disableOxcRecommendation)
        config.logger.warn("[vite:react-babel] We recommend switching to `@vitejs/plugin-react-oxc` for improved performance. More information at https://vite.dev/rolldown");
      if (hooks.length > 0)
  ...
  const viteReactRefresh = {
    ...
    load: {
      ...
      handler(id) {
        if (id === runtimePublicPath)
          return (0, import_node_fs.readFileSync)(refreshRuntimePath, "utf-8").replace(/__README_URL__/g, "https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react");
      }
    },
...
function getReactCompilerRuntimeModule(plugin) {
  ...
  if (Array.isArray(plugin)) {
    ...
    if (((_plugin$ = plugin[1]) === null || _plugin$ === void 0 ? void 0 : _plugin$.target) === "17" || ((_plugin$2 = plugin[1]) === null || _plugin$2 === void 0 ? void 0 : _plugin$2.target) === "18")
