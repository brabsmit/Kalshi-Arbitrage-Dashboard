    ...
    return (
        <tr className="hover:bg-slate-50 group">
            ...
            <td className="px-4 py-3 text-center flex justify-center gap-2">
                {item.isOrder && (
                    <button aria-label={`Cancel Order for ${item.marketId}`} onClick={() => onCancel(item.id)} className="text-slate-400 hover:text-rose-600 transition-colors rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500" title="Cancel Order">
                        <XCircle size={16}/>
                    </button>
                )}
                <button
                    ...
                    className="text-slate-300 hover:text-blue-600 disabled:opacity-20 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                >
                    <Info size={16}/>
                </button>
            </td>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-[300px]">
             <div className="p-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
                ...
                <button
                    ...
                    className="p-1.5 rounded hover:bg-slate-200 text-slate-400 hover:text-slate-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-30"
