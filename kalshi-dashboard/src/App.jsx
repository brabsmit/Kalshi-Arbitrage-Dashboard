...
const Header = ({ balance, portfolioValue, isRunning, setIsRunning, onSaveSession, lastUpdated, isTurboMode, onConnect, connected, wsStatus, wsStats, onOpenSettings, onOpenExport, onOpenSchedule, apiUsage, isScheduled }) => {
    ...
    <header className="mb-6 flex flex-col md:flex-row justify-between items-center gap-4 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 transition-colors duration-200">
        <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2"><TrendingUp className="text-blue-600" /> Kalshi ArbBot <span className="text-xs font-mono text-slate-400">v1.1.2 (2026-01-24)</span></h1>
    ...
    return (
        <th className="p-0 bg-slate-50 border-b border-slate-200 select-none font-medium text-slate-500" aria-sort={ariaSort}>
            <button
                ...
                className={`w-full h-full px-2 py-2 flex items-center gap-1 hover:bg-slate-100 focus-visible:bg-slate-100 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-500 outline-none transition-colors group ${justifyClass}`}
            >
                    ...
                    <tr>
                        ...
                        {activeTab === 'positions' && (
                            <>
                                ...
                                <SortableHeader label="Prices" sortKey="avgPrice" currentSort={sortConfig} onSort={onSort} align="center" />
                                ...
                                <SortableHeader label="Exit" sortKey="exitOrder" currentSort={sortConfig} onSort={onSort} align="center" />
                            </>
                        )}
                        ...
                        {activeTab === 'resting' && (
                            <>
                                ...
                                <SortableHeader label="FV / Dist" sortKey="fv" currentSort={sortConfig} onSort={onSort} align="center" />
