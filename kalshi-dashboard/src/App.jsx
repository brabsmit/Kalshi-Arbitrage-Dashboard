        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-[300px]">
             <div className="p-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
                ...
                <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded transition-all focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                    {isCopied ? <Check size={16} className="text-emerald-500"/> : <Copy size={16}/>}
                </button>
            </div>
            <div ref={scrollRef} className="overflow-y-auto p-4 space-y-2 flex-1 font-mono text-xs" role="log" aria-live="polite" aria-atomic="false">
