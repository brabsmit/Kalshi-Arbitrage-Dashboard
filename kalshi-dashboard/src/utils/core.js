...
export const calculateStrategy = (market, marginPercent) => {
    ...
    // Increase margin as the event approaches to account for stale data risk and high volatility.
    if (market.commenceTime) {
        ...
        if (hoursRemaining < 1) {
             effectiveMargin += 5; // Imminent/Live: +5% margin safety
        } else if (hoursRemaining < 24) {
             effectiveMargin += 1; // < 24h: +1% margin safety
        }
    }
